        ...
        <div className="flex flex-col gap-[24px] items-center p-[40px_24px] bg-[url(/icons/green-flower-icon.svg)] bg-no-repeat bg-contain bg-[left_top_50px]">
          ...
          <div className="flex flex-col gap-[16px] items-center bg-[url(/shadows/green-shadow.png)] bg-no-repeat bg-contain bg-[center_top_-60px]">
            ...
            <p className="text-center text-[14px] font-light">
              ...
              inicio caótico: entre una apendicitis y el embarazo de mi mamá,
              este caos dio paso al comienzo de una vida llena de alegrías,
              desafíos y enojos. Sumando momentos de aprendizaje junto al resto
              de mi familia. A lo largo de los años y con la ayuda de amistades
              y seres queridos, he creado aventuras cotidianas que me ayudado a
              crecer.
              <br />
              <br />
              ...
              la vida nos ha puesto en el camino, y sin olvidar esas amistades
              que están presentes siempre. Ahora entiendo la importancia de los
              recuerdos. Teniendo a tantas personas a las que quiero, aunque no
              las vea tan seguido como me gustaría. Personas que se preocupan
              por mí, que me aconsejan con cariño, que desean mi bienestar.
              Personas que han soportado mis malos días y han celebrado conmigo
              los buenos. Hoy me acordé de ustedes, porque los tengo presente.
              <br />
          ...
          <div className="bg-[url(/bgs/info-bg-mobile.png)] bg-no-repeat bg-cover bg-[100%_center] w-full h-[593px] rounded-[20px] flex flex-col gap-[24px] justify-end p-[24px]">
            <div className="flex flex-col">
              ...
              <p className="text-[#FFF]/80 italic font-thin">
                Por favor, intenta <b>llegar a tiempo</b> para que disfrutes de
                mi acto de entrada
              </p>
            </div>
          ...
          <div className="flex flex-col gap-[24px] items-center">
            <div className="flex flex-col gap-[40px] items-center">
              ...
              <p className="text-center">
                ...
                viejo, verde oliva y gris claro. Queremos que luzcas increíble y
                que el ambiente refleje armonía y sofisticación.
                <br />
                <br />
